...
var UIColorPicker = (function UIColorPicker() {
    ...
    Color.prototype.copy = function copy(obj) {
        if (obj instanceof Color !== true) {
            console.debug('Typeof parameter not Color');
            return;
        }
    ...
    function ColorPicker(node) {
        ...
        this.newInputComponent('hexa', 'hexa', this.inputChangeHexa.bind(this), 'btnColorChange');
    ...
    ColorPicker.prototype.newInputComponent = function newInputComponent(title, topic, onChangeFunc, className) {
        (className == undefined) ? className = "" : className;
        var wrapper = document.createElement('div');
        var input = document.createElement('input');
        var info = document.createElement('span');

        wrapper.className = 'input btnColorChange';
    ...
    ColorPicker.prototype.updateColor = function updateColor(e) {
        ...
        var x = e.pageX - $(".picking-area").offset().left;
        var y = e.pageY - $(".picking-area").offset().top;
        var picker_offset = 5;
    ...
    ColorPicker.prototype.updateAlphaSlider = function updateAlphaSlider(e) {
        ...
        var x = e.pageX - $(".alpha").offset().left;
...
var ColorPickerTool = (function ColorPickerTool() {
    ...
    var UIComponent = (function UIComponent() {
        ...
        var makeDraggable = function makeDraggable(elem, endFunction) {
            ...
            var dragStart = function dragStart(e) {
                ...
                offsetLeft = e.clientX - $(e.currentTarget).offset().left;
                offsetTop = e.clientY - $(e.currentTarget).offset().top;
    ...
    var ColorPalette = (function ColorPalette() {
        ...
        var createHuePalette = function createHuePalette() {
            ...
            color_palette.id = 'color-palette';
    ...
    var ColorInfo = (function ColorInfo() {
        ...
        var HEXA;
        var HSLA;
        var info_box = document.createElement('input');
        info_box.id = 'color-info';
    ...
    getEditorWindow().UpdateUndoHistory();
})();

//--------update color----------//
$(".btnColorChange").click(function () {
    try {
        updatepicker = $("this")[0].value;
        $(".LblImagehigh").css("background", updatepicker);
        getEditorWindow().TextHighlight();
        $('.colorPickerPanel').removeClass('active');
        $('.ImdToolBarContainer').css('visibility', 'hidden');
    } catch (e) {
        console.debug('Problem in color applying: ' + e.message);
    }
});


//--------click function--------//
$(".LblImagehigh").click(function () {
